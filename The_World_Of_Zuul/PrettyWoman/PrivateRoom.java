...
{    
    ...
    public void pRoomTips(int bonus){
        double amount = Math.round((tipsGained(getEnhancements()*6.5+350+bonus))*100.0)/100.0;
        System.out.println("You gained $" + amount + " from dancing.");
        System.out.println("You have $"+getMoneySaved());
        addMoneySaved(amount);
    }
